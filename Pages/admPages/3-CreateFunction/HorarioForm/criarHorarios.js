...
// Função para adicionar um novo campo de horário
...
// Função para remover o último campo de horário
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addButton.addEventListener('click', function(event) {
        ...
        adicionarHorario();      // Adiciona um novo campo de horário
    });
    ...
    removeButton.addEventListener('click', function(event) {
        event.preventDefault();  // Impede o comportamento de submit
        removerHorario();        // Remove o último campo de horário
    });
